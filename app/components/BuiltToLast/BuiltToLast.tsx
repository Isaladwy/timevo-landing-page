...
const BuiltToLast = () => {
  return (
    <section
      dir="rtl"
      className="w-full bg-gradient-to-b from-neutral-900 via-neutral-950 to-neutral-900 flex flex-col md:flex-row items-center justify-between gap-16 py-20 px-4 md:px-24"
    >
      {/* Image in a card */}
