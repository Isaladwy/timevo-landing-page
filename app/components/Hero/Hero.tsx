  ...
  return (
    <section className="relative bg-gradient-to-br from-neutral-900 via-orange-900 to-neutral-800 text-white min-h-[70vh] flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 gap-10">
      ...
      <div className="flex-1 flex items-center justify-center z-10">
        <div className="w-[300px] h-[300px] md:w-[400px] md:h-[400px] bg-gradient-to-tr from-orange-700 to-neutral-900 rounded-3xl flex items-center justify-center shadow-2xl">
      ...
      <div className="absolute right-0 top-0 w-1/2 h-full bg-orange-800 opacity-20 rounded-bl-full pointer-events-none" />
    </section>
  );
};
